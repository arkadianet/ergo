...
`GET /api/v1/node/health` to confirm a running node's state."
    ...
    paths(
        ...
        crate::v1::routes::prices::get_prices,
    ...
    components(schemas(
            ...
            crate::v1::routes::prices::PriceItem,
            crate::v1::routes::prices::PricePathHop,
            crate::v1::routes::prices::PriceSource,
            crate::v1::routes::prices::PriceValue,
            crate::v1::routes::prices::PricesQuery,
            crate::v1::routes::prices::PricesResponse,
            crate::v1::routes::prices::RawPrice,
