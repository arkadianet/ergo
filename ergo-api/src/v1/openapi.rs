...
`GET /api/v1/node/health` to confirm a running node's state."
    ...
    paths(
        ...
        crate::v1::routes::wallet_chain::tip,
        crate::v1::routes::wallet_chain::snapshot,
        crate::v1::routes::wallet_chain::box_lookup,
        crate::v1::routes::wallet_chain::blocks_since,
        crate::v1::routes::wallet_chain::submit,
    ...
    components(schemas(
            ...
            crate::v1::routes::wallet_chain::WalletChainTip,
            crate::v1::routes::wallet_chain::WalletChainHeader,
            crate::v1::routes::wallet_chain::WalletChainReemissionInput,
            crate::v1::routes::wallet_chain::WalletChainSnapshot,
            crate::v1::routes::wallet_chain::WalletChainAsset,
            crate::v1::routes::wallet_chain::WalletChainBox,
            crate::v1::routes::wallet_chain::WalletChainInput,
            crate::v1::routes::wallet_chain::WalletChainOutput,
            crate::v1::routes::wallet_chain::WalletChainTransaction,
            crate::v1::routes::wallet_chain::WalletChainBlock,
            crate::v1::routes::wallet_chain::WalletChainCursor,
            crate::v1::routes::wallet_chain::WalletChainBlocksSinceResponse,
            crate::v1::routes::wallet_chain::WalletChainPrunedBlocksSinceResponse,
            crate::v1::routes::wallet_chain::WalletChainBoxLookupResponse,
            crate::v1::routes::wallet_chain::WalletChainSubmitRequest,
            crate::v1::routes::wallet_chain::WalletChainSubmitReason,
