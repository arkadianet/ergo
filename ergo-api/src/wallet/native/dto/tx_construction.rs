//! Transaction-construction DTOs (§3.5): the tagged TxRepr wire shape,
//! OutputIntent / InputSource / DataInputSource (manual Deserialize with
//! cross-variant field-leak rejection, moved verbatim), TxIntent, box
//! selection, and the sign/send request/response shapes. SECURITY: the
//! ExternalSecret / SignTxRequest Debug impls redact secret material and
//! are moved verbatim.
