...
pub const JS_CHAIN_ACTIVITY: &str = include_str!("../web/js/chain-activity.js");
pub const JS_ACTIVITY: &str = include_str!("../web/js/activity.js");
pub const JS_ACTIVITY_MODEL: &str = include_str!("../web/js/activity-model.js");
pub const JS_NODE_GUIDANCE: &str = include_str!("../web/js/node-guidance.js");
pub const JS_SYNC_RINGS: &str = include_str!("../web/js/sync-rings.js");
pub const JS_STORAGE_RENT: &str = include_str!("../web/js/storage-rent.js");
