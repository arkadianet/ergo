...
//!   at steps 5/6.
//!
//! [`validate_epoch_extension`] itself stays whole: it implements
//! `processExtension` step-by-step with a subtle three-way branch at
//! step 7 (strict match / trust-bypass / reject) whose ordering
//! guarantees are pinned in the inline comments.
...
use match_rules::{match_parameters, match_parameters_60};
