...
mod tests {
    ...
    /// Verifies that the emission contract ErgoTree bytes produce the correct
    /// mainnet P2S addresses, as returned by the live Scala reference node's
    /// `/emission/scripts` endpoint.
    #[test]
    fn emission_scripts_addresses_mainnet() {
        // Serialized ErgoTree bytes for each emission contract.
        // Extracted by Base58-decoding the known-correct addresses from the
        // Scala reference node and stripping the 1-byte prefix and 4-byte checksum.

        let emission_tree: &[u8] = &[
            ,
        ];

        let reemission_tree: &[u8] = &[
            ,
        ];

        let pay2reemission_tree: &[u8] = &[
            0x19, 0x3c, 0x03, 0x04, 0x00, 0x04, 0x00, 0x0e, 0x20, 0xd3, 0xfe, 0xef, 0xfa, 0x87,
            0xf2, 0xdf, 0x63, 0xa7, 0xa1, 0x5b, 0x49, 0x05, 0xe6, 0x18, 0xae, 0x3c, 0xe4, 0xc6,
            0x9a, 0x79, 0x75, 0xf1, 0x71, 0xbd, 0x31, 0x4d, 0x0b, 0x87, 0x79, 0x27, 0xb8, 0xd1,
            0x93, 0x8c, 0xb2, 0xe4, 0xc6, 0xb2, 0xa5, 0x73, 0x00, 0x00, 0x02, 0x0c, 0x4d, 0x0e,
            0x73, 0x01, 0x00, 0x01, 0x73, 0x02,
        ];

        // Known-correct mainnet addresses from the live Scala reference node.
        let expected_emission = "";
        let expected_reemission = "";
        let expected_pay2reemission = "6KxusedL87PBibr1t1f4ggzAyTAmWEPqSpqXbkdoybNwHVw5Nb7cUESBmQw5XK8TyvbQiueyqkR9XMNaUgpWx3jT54p";

        assert_eq!(
            ergo_tree_to_address(emission_tree, NetworkPrefix::Mainnet),
            expected_emission,
            "emission contract address mismatch"
        );
        assert_eq!(
            ergo_tree_to_address(reemission_tree, NetworkPrefix::Mainnet),
            expected_reemission,
            "reemission contract address mismatch"
        );
        assert_eq!(
            ergo_tree_to_address(pay2reemission_tree, NetworkPrefix::Mainnet),
            expected_pay2reemission,
            "pay2Reemission contract address mismatch"
        );
    }
}
