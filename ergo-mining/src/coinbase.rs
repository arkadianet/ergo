...
///
/// `pub(crate)` so the storage-rent broadcast builder (`rent_broadcast.rs`,
/// Phase 1b) reuses these exact bytes for its parent fee output instead of
/// keeping a second copy.
pub(crate) const MAINNET_FEE_PROPOSITION_BYTES: &[u8] = &[
