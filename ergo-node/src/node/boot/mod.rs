...
async fn run_inner_with_backend(
    ...
    let api_bind = api_wiring::bind(
        ...
        scaffold.native_snapshot.clone(),
        scaffold.native_recent.clone(),
        scaffold.native_peers.clone(),
        scaffold.native_events.clone(),
        scaffold.native_host.clone(),
        scaffold.submit_bridge.clone(),
        scaffold.native_transactions.clone(),
