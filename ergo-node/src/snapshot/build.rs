...
pub(super) fn build_snapshot(
    ...
    let status = ApiStatus {
        ...
        storage_errors_state_total: p.storage_errors_state_total,
        storage_errors_indexer_total: p.storage_errors_indexer_total,
        storage_errors_peers_total: p.storage_errors_peers_total,
        last_storage_error: p.last_storage_error.clone(),
