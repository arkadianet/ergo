...
pub use wallet::{
    ...
    fence_wallet_apply, migrate_schema, migrate_standalone_schema, owned_to_block_txs,
    set_wallet_finalization_in_progress, set_wallet_finalization_owned, unfence_wallet_apply,
    wait_for_wallet_finalization, wallet_apply_fenced, wallet_apply_generation,
    wallet_finalization_in_progress, wallet_finalization_owned, Balance, BlockOutput, BlockTx,
