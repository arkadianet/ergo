...
pub fn apply_block_to_scans_rescan(
    txn: &WriteTransaction,
    scan_matches: &[ScanMatchRecord],
    txs: &[BlockTx<'_>],
    block_height: u32,
...
pub fn rollback_scans_from_block(
    txn: &WriteTransaction,
    txs: &[BlockTx<'_>],
    block_height: u32,
) -> Result<(), redb::Error> {
...
pub fn clear_scan_tracking(txn: &WriteTransaction) -> Result<(), redb::Error> {
...
pub fn clear_scan_registry(txn: &WriteTransaction) -> Result<(), redb::Error> {
